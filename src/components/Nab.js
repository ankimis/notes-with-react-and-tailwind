                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown" id="ondropdownbyweater">
                      <li><a className="dropdown-item ondropdownbyweater" href="/">Delhi</a></li>
                      <li><a className="dropdown-item ondropdownbyweater" href="/">Settle</a></li>
                      <li><hr className="dropdown-divider"/></li>
                      <li><a className="dropdown-item ondropdownbyweater"  href="/">Bangalore</a></li>
                    </ul>
                  </li>
                  <li className="nav-item">
